...
-- 3. DISPLAY ALL CONFIRMED BOOKINGS IN DESCENDING ORDER OF BOOKING DATE
SELECT *
FROM booking
...
-- 6. DISPLAY CUSTOMER NAME AND ROOM NUMBER USING CUSTOMER, BOOKING AND ROOM
...
-- 9. UPDATE BOOKING STATUS TO COMPLETED AND CHECK ROOM STATUS USING TRIGGER
...
-- 11. DISPLAY ROOMS WHOSE PRICE PER NIGHT IS GREATER THAN OR EQUAL TO THE AVERAGE ROOM PRICE
...
-- 12. DISPLAY PAYMENT METHODS FOR PAYMENTS WHERE AMOUNT IS AT LEAST 10000
...
-- 13. DISPLAY PAYMENT METHODS WHERE MAXIMUM PAYMENT AMOUNT IS GREATER THAN 15000
